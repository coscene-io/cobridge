...
#ifndef CALLBACK_QUEUE_HPP_
#define CALLBACK_QUEUE_HPP_
    ...
    while (!_quit) {
      ...
      if (_quit) {
        ...
        try {
          ...
          _log_callback(WebSocketLogLevel::Error, "Caught unhandled exception in callback_queue.");
        }
      }
    }
  }
