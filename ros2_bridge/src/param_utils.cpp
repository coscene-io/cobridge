...
void declare_parameters(rclcpp::Node *node)
{
  ...
  node->declare_parameter(
    PARAM_SEND_BUFFER_LIMIT, DEFAULT_SEND_BUFFER_LIMIT,
  ...
  min_qos_depth_description.description =
  ...
  max_qos_depth_description.description =
  ...
  node->declare_parameter(
    PARAM_TOPIC_WHITELIST, std::vector<std::string>({".*"}),
  ...
  node->declare_parameter(
    PARAM_SERVICE_WHITELIST, std::vector<std::string>({".*"}),
  ...
  node->declare_parameter(
    PARAM_PARAMETER_WHITELIST, std::vector<std::string>({".*"}),
  ...
  client_topic_whitelist_description.type =
  ...
  node->declare_parameter(
    PARAM_CLIENT_TOPIC_WHITELIST, std::vector<std::string>({".*"}),
    param_whitelist_description);
